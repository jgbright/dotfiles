    ...
    $CommandWithLogging = switch ($PsCmdlet.ParameterSetName) {
        'Self' {
            if ($Self) {
                ...
                Get-PwshCommandWithLog -File $Self -LogSlug $LogSlug
            }
            else {
                ...
                Get-PwshCommandWithLog -Command $CommandWithoutLogging -LogSlug $LogSlug
            }
        }
        'Command' {
            $CommandWithoutLogging = $Command
            Get-PwshCommandWithLog -Command $Command -LogSlug $LogSlug
        }
        'File' {
            $CommandWithoutLogging = $File
            Get-PwshCommandWithLog -File $File -LogSlug $LogSlug
        }
    }
